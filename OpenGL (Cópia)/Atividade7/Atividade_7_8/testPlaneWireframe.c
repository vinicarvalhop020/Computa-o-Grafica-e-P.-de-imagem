...
const char *PROGNAME = "Atividade 7.8 – Sphere Persp";
const char *BASEDIR = "/home/vini-carvalho/Documentos/EA979/OpenGL (Cópia)/Atividade7/Atividade_7_8";
...
void display(GLFWwindow* window) {
    ...
    frustum(-1.0f, 1.0f, -1.0f, 1.0f, 1.0f, 10.0f, projMatrix);
   ...
   // 	fflush(stdout);
        ...
        glPointSize(2.0f);
        glDrawArrays(GL_POINTS, 0, planeNumVertices);
