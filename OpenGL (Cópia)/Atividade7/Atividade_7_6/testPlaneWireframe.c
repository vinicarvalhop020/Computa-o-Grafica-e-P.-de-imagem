...
const char *PROGNAME = "Atividade 7.6 – Cube Persp";
const char *BASEDIR = "/home/vini-carvalho/Documentos/EA979/OpenGL (Cópia)/Atividade7/Atividade_7_6";
...
void display(GLFWwindow* window) {
    ...
    frustum(-1.0f, 1.0f, -1.0f, 1.0f, 2.0f, 10.0f, projMatrix);
    ...
    lookAt(0, 0 ,4, 0, 0, 0, 0, 1, 0, viewMatrix);
