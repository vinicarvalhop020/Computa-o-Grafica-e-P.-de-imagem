...
const char *PROGNAME = "Atividade 8.5 – Esfera tonalizacao phong iluminacao phong";
const char *BASEDIR = "/home/vini-carvalho/Documentos/EA979/OpenGL (Cópia 2)/Atividade8/Atividade_8_5";
...
void display(GLFWwindow* window) {
   ...
   // 	fflush(stdout);
        ...
        // --- Defina as uniforms de iluminação ---
        // Posição da Câmera
