...
const char *PROGNAME = "Atividade 8.7 – Esfera tonalizacao e iluminacao Phong com textura";
const char *BASEDIR = "/home/vini-carvalho/Documentos/EA979/OpenGL (Cópia 2)/Atividade8/Atividade_8_7";
...
void init(void) {
    ...
    // ---------------------------------------
    glGenBuffers(4, VBO); //gera os 3 buffers: vertices, normals, colors
    ...
    //flip horizontalmente a imagem    
    unsigned char *tex_data = stbi_load("earth.jpg", &width, &height, &channels, 0);

    if (tex_data) {
        // define a textura com os dados da imagem
