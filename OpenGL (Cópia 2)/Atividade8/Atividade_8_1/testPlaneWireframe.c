...
const char *PROGNAME = "Atividade 8.1 – Cubo tonalizacao Gouraud e iluminacao Phong";
const char *BASEDIR = "/home/vini-carvalho/Documentos/EA979/OpenGL (Cópia 2)/Atividade8/Atividade_8_1";
...
void display(GLFWwindow* window) {
    ...
    //matrizes utilizadas no shader, e uniforms
   ...
   // 	fflush(stdout);
        ...
        // Posição da Luz
        GLfloat lightPos[] = {0.0f, 0.50f, 2.0f};
