...
const char *PROGNAME = "Atividade 8.5 – Esfera tonalizacoa gouraud, iluminacao phong, com textura";
const char *BASEDIR = "/home/vini-carvalho/Documentos/EA979/OpenGL (Cópia 2)/Atividade8/Atividade_8_6";
...
void init(void) {
    ...
    unsigned char *tex_data = stbi_load("jupitermap.jpg", &width, &height, &channels, 0);
